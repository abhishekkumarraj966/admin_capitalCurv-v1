    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500 min-h-screen pb-10">
            <div className="flex items-center justify-between">
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Referrals Management</h1>
                <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    ...
                    <div key={index} className="bg-white dark:bg-[#021F17] p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-[#021F17]">
            ...
            <div className="bg-white dark:bg-[#021F17] rounded-2xl shadow-sm border border-gray-100 dark:border-[#021F17] overflow-hidden">
                <div className="p-6 border-b border-gray-100 dark:border-[#021F17]">
                    <h2 className="text-lg font-bold text-gray-900 dark:text-white">All Referrals</h2>
                </div>
                    ...
                    <table className="w-full text-left">
                        <thead className="bg-gray-50 dark:bg-[#021F17]">
                            <tr>
                                ...
                                <th className="p-4 text-xs font-bold text-gray-500 uppercase">Referred By</th>
                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-[#021F17]">
                            {loading ? (
                                ...
                                <tr><td colSpan={6} className="p-8 text-center text-gray-500">No referrals found.</td></tr>
                            ) : (
                                referrals.map((ref: any) => (
                                    <tr key={ref._id} className="hover:bg-gray-50/50 dark:hover:bg-[#000F0A]/50 transition-colors">
                                        <td className="p-4">
                                            <div className="text-sm font-bold text-gray-900 dark:text-white">{ref.userId?.name || ref.userId || 'Unknown'}</div>
                                            <div className="text-xs text-gray-500">{ref.userId?.email}</div>
                                        </td>
                                        <td className="p-4">
                                            <div className="text-sm text-gray-600 dark:text-gray-300">{ref.referredBy?.name || ref.referredBy || '-'}</div>
                                        </td>
